...
本デモは、心理動詞・伝聞語を用いた厳密な主語推定を行わず、助詞および逆接表現によって形成される主体間の関係性に着目した軽量な文脈分類を行う。
...
デモでは、B（弱）を含意・評価表現のみが検出された基底状態とし、
逆接・間投詞・疑問化などの態度トリガー語彙が検出された場合に、
B（強）へ昇格させるルールベース構成を採用している。
